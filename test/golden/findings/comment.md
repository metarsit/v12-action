...
Fingerprint `c9ecb9cf8cf93ea3` · validity valid · [View on V12](https://v12.sh/runs/42/104) · [Source](https://github.com/acme/vault/blob/1111111111111111111111111111111111111111/contracts/Permit.sol#L30-L41)
</details>
<details>
...
Fingerprint `03fd1caea09bb909` · validity valid · [View on V12](https://v12.sh/runs/42/101) · [Source](https://github.com/acme/vault/blob/1111111111111111111111111111111111111111/contracts/Vault.sol#L118-L121)
</details>
<details>
...
Fingerprint `d8c8bf0ce16a1089` · validity unreviewed · [View on V12](https://v12.sh/runs/42/103) · [Source](https://github.com/acme/vault/blob/1111111111111111111111111111111111111111/contracts/Rewards.sol#L55-L57)
</details>
<details>
<summary>Critical: Unchecked external call return value &#124; funds stuck in escrow (new)</summary>
...
Fingerprint `75001bd88146f0dc` · validity unreviewed · [View on V12](https://v12.sh/runs/42/102) · [Source](https://github.com/acme/vault/blob/1111111111111111111111111111111111111111/contracts/Vault.sol#L200)
</details>
<details>
<summary>High: &lt;script&gt;alert(1)&lt;/script&gt; Nonce reuse in signing routine (new)</summary>
...
Fingerprint `76e409073bcd488c` · validity valid · [View on V12](https://v12.sh/runs/42/118) · [Source](https://github.com/acme/vault/blob/1111111111111111111111111111111111111111/src/crypto/sign.rs#L90-L105)
</details>
<details>
<summary>High: Missing access control on &#96;setOwner&#96; (new)</summary>
...
Fingerprint `76e409073bcd488c` · validity unreviewed · [View on V12](https://v12.sh/runs/42/105) · [Source](https://github.com/acme/vault/blob/1111111111111111111111111111111111111111/src/crypto/sign.rs#L40-L55)
</details>
<details>
<summary>High: Path traversal in module loader (new)</summary>
...
Fingerprint `726c9cf20e4e84bd` · validity unreviewed · [View on V12](https://v12.sh/runs/42/122) · [Source](https://github.com/acme/vault/blob/1111111111111111111111111111111111111111/src/m%C3%B3dulo/file%20name.sol#L7-L9)
</details>
<details>
<summary>Medium: Price manipulation through flash-loaned liquidity (new)</summary>
...
Fingerprint `44d3f84c9ccf8d87` · validity valid · [View on V12](https://v12.sh/runs/42/123) · [Source](https://github.com/acme/vault/blob/1111111111111111111111111111111111111111/contracts/Vault.sol#L250-L262)
</details>
<details>
<summary>Medium: Oracle staleness not checked (new)</summary>
...
Fingerprint `6bf6cb80de410fab` · validity unreviewed · [View on V12](https://v12.sh/runs/42/119) · [Source](https://github.com/acme/vault/blob/1111111111111111111111111111111111111111/contracts/Oracle.sol#L44)
</details>
<details>
<summary>Medium: Überprüfung fehlt — signature malleability 🚨 (new)</summary>
...
Fingerprint `f13a7794ac00ef21` · validity unreviewed · [View on V12](https://v12.sh/runs/42/111) · [Source](https://github.com/acme/vault/blob/1111111111111111111111111111111111111111/contracts/Permit.sol#L70-L72)
</details>
<details>
<summary>Medium: Unbounded loop over depositors (new)</summary>
...
Fingerprint `e0c83f9665503f0a` · validity unreviewed · [View on V12](https://v12.sh/runs/42/110) · [Source](https://github.com/acme/vault/blob/1111111111111111111111111111111111111111/contracts/Vault.sol#L300-L310)
</details>
<details>
<summary>Low: Floating pragma (new)</summary>
...
Fingerprint `c489c926ca7979b7` · validity unreviewed · [View on V12](https://v12.sh/runs/42/113) · [Source](https://github.com/acme/vault/blob/1111111111111111111111111111111111111111/contracts/Vault.sol#L2)
</details>
<details>
<summary>Low: Rounding favours the caller in share math (new)</summary>
...
Fingerprint `c40df8f19d04fda8` · validity unreviewed · [View on V12](https://v12.sh/runs/42/125) · [Source](https://github.com/acme/vault/blob/1111111111111111111111111111111111111111/contracts/Vault.sol#L140-L142)
</details>
<details>
<summary>Info: Event missing for ownership transfer (new)</summary>
...
Fingerprint `2b1e12b62d22fe0a` · validity unreviewed · [View on V12](https://v12.sh/runs/42/114) · [Source](https://github.com/acme/vault/blob/1111111111111111111111111111111111111111/contracts/Ownable.sol#L20-L22)
</details>
<details>
<summary>Info: Redundant zero-address check (new)</summary>

**Description**

Auto-invalidated: the check is not redundant after all.
...
Fingerprint `130eaf066b1505ce` · validity unreviewed · [View on V12](https://v12.sh/runs/42/124) · [Source](https://github.com/acme/vault/blob/1111111111111111111111111111111111111111/contracts/Vault.sol#L80)
</details>
...
<!-- v12-audit-action:state: -->